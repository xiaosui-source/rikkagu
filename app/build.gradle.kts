...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = System.getenv("KEYSTORE_PASSWORD") ?: "Abc123456789@xyz"
            keyAlias = System.getenv("KEY_ALIAS") ?: "auto_key"
            keyPassword = System.getenv("KEY_PASSWORD") ?: "Abc123456789@xyz"
        }
    }
