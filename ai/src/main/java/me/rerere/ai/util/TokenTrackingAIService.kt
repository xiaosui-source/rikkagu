...
import me.rerere.rikkahub.data.modelModelOption
import me.rerere.rikkahub.data.modelModelParameter
import me.rerere.rikkahub.data.modelTokenUsageRecordEntity
import me.rerere.rikkahub.data.modelToolPrompt
import me.rerere.rikkahub.data.statsProviderUsageSnapshot
import me.rerere.rikkahub.data.statsTokenUsageRepository
import me.rerere.ai.util.AppLogger
import me.rerere.ai.util.streamRevisableTextStream
import me.rerere.ai.util.streamSharedStream
...
import me.rerere.ai.util.streamTextStreamEventCarrier
...
class TokenTrackingAIService(
    ...
    private suspend fun forwardUsageObserver(
        ...
        try {
            ...
            android.util.Log.e(TAG, "usage observer failed", e)
        }
    }
    ...
    private suspend fun forwardUsageFinalizedObserver(
        ...
        try {
            ...
            android.util.Log.e(TAG, "usage completion observer failed", e)
        }
    }
        ...
        private suspend fun persist(
            ...
            withContext(Dispatchers.IO + NonCancellable) {
                try {
                    ...
                    android.util.Log.e(TAG, "token usage insert failed", e)
                }
            }
        }
